...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "x", function() { return __DEBUG__; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return __PERFORMANCE_PROFILE__; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return TREE_OPERATION_ADD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return TREE_OPERATION_REMOVE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return TREE_OPERATION_REORDER_CHILDREN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return TREE_OPERATION_UPDATE_TREE_BASE_DURATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return TREE_OPERATION_REMOVE_ROOT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return LOCAL_STORAGE_DEFAULT_TAB_KEY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return LOCAL_STORAGE_FILTER_PREFERENCES_KEY; });
/* unused harmony export SESSION_STORAGE_LAST_SELECTION_KEY */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return LOCAL_STORAGE_PARSE_HOOK_NAMES_KEY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return SESSION_STORAGE_RECORD_CHANGE_DESCRIPTIONS_KEY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return SESSION_STORAGE_RELOAD_AND_PROFILE_KEY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return LOCAL_STORAGE_SHOULD_BREAK_ON_CONSOLE_ERRORS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return LOCAL_STORAGE_SHOULD_PATCH_CONSOLE_KEY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return LOCAL_STORAGE_SHOW_INLINE_WARNINGS_AND_ERRORS_KEY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return LOCAL_STORAGE_TRACE_UPDATES_ENABLED_KEY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return LOCAL_STORAGE_HIDE_CONSOLE_LOGS_IN_STRICT_MODE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return PROFILER_EXPORT_VERSION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CHANGE_LOG_URL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "w", function() { return UNSUPPORTED_VERSION_URL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return REACT_DEVTOOLS_WORKPLACE_URL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return THEME_STYLES; });
...
var src_constants = __webpack_require__(16);
...
if (Object(storage["d" /* sessionStorageGetItem */])(constants["o" /* SESSION_STORAGE_RELOAD_AND_PROFILE_KEY */]) === 'true') {
...
function printOperationsArray(operations) {
  ...
  while (i < operations.length) {
    ...
    switch (operation) {
      case constants["q" /* TREE_OPERATION_ADD */]:
        {
      ...
      case constants["r" /* TREE_OPERATION_REMOVE */]:
        {
      ...
      case constants["s" /* TREE_OPERATION_REMOVE_ROOT */]:
        {
          i += 1;
      ...
      case constants["t" /* TREE_OPERATION_REORDER_CHILDREN */]:
        {
          const id = operations[i + 1];
      ...
      case constants["v" /* TREE_OPERATION_UPDATE_TREE_BASE_DURATION */]:
      ...
      case constants["u" /* TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS */]:
        const id = operations[i + 1];
...
function getSavedComponentFilters() {
  try {
    const raw = Object(storage["a" /* localStorageGetItem */])(constants["e" /* LOCAL_STORAGE_FILTER_PREFERENCES_KEY */]);
...
function saveComponentFilters(componentFilters) {
  Object(storage["c" /* localStorageSetItem */])(constants["e" /* LOCAL_STORAGE_FILTER_PREFERENCES_KEY */], JSON.stringify(componentFilters));
}
function getAppendComponentStack() {
  try {
    const raw = Object(storage["a" /* localStorageGetItem */])(constants["i" /* LOCAL_STORAGE_SHOULD_PATCH_CONSOLE_KEY */]);
...
function setAppendComponentStack(value) {
  Object(storage["c" /* localStorageSetItem */])(constants["i" /* LOCAL_STORAGE_SHOULD_PATCH_CONSOLE_KEY */], JSON.stringify(value));
}
function getBreakOnConsoleErrors() {
  try {
    const raw = Object(storage["a" /* localStorageGetItem */])(constants["h" /* LOCAL_STORAGE_SHOULD_BREAK_ON_CONSOLE_ERRORS */]);
...
function setBreakOnConsoleErrors(value) {
  Object(storage["c" /* localStorageSetItem */])(constants["h" /* LOCAL_STORAGE_SHOULD_BREAK_ON_CONSOLE_ERRORS */], JSON.stringify(value));
}
function getHideConsoleLogsInStrictMode() {
  try {
    const raw = Object(storage["a" /* localStorageGetItem */])(constants["f" /* LOCAL_STORAGE_HIDE_CONSOLE_LOGS_IN_STRICT_MODE */]);
...
function sethideConsoleLogsInStrictMode(value) {
  Object(storage["c" /* localStorageSetItem */])(constants["f" /* LOCAL_STORAGE_HIDE_CONSOLE_LOGS_IN_STRICT_MODE */], JSON.stringify(value));
}
function getShowInlineWarningsAndErrors() {
  try {
    const raw = Object(storage["a" /* localStorageGetItem */])(constants["j" /* LOCAL_STORAGE_SHOW_INLINE_WARNINGS_AND_ERRORS_KEY */]);
...
function setShowInlineWarningsAndErrors(value) {
  Object(storage["c" /* localStorageSetItem */])(constants["j" /* LOCAL_STORAGE_SHOW_INLINE_WARNINGS_AND_ERRORS_KEY */], JSON.stringify(value));
}
...
/* harmony import */ var _DevToolsFiberComponentStack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(63);
...
var react_debug_tools = __webpack_require__(62);
...
function attach(hook, rendererID, renderer, global) {
  ...
  function updateComponentFilters(componentFilters) {
    ...
    hook.getFiberRoots(rendererID).forEach(root => {
      ...
      pushOperation(constants["s" /* TREE_OPERATION_REMOVE_ROOT */]);
  ...
  function recordPendingErrorsAndWarnings() {
    ...
    fibersWithChangedErrorOrWarningCounts.forEach(fiber => {
      ...
      if (fiberID === null) {// Don't send updates for Fibers that didn't mount due to e.g. Suspense or an error boundary.
        ...
        pushOperation(constants["u" /* TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS */]);
  ...
  function flushPendingEvents(root) {
    ...
    if (numUnmountIDs > 0) {
      ...
      operations[i++] = constants["r" /* TREE_OPERATION_REMOVE */]; // The first number is how many unmounted IDs we're gonna send.
  ...
  function recordMount(fiber, parentFiber) {
    ...
    if (isRoot) {
      pushOperation(constants["q" /* TREE_OPERATION_ADD */]);
      pushOperation(id);
  ...
  function recordProfilingDurations(fiber) {
    ...
    if (isProfiling) {
      ...
      if (alternate == null || treeBaseDuration !== alternate.treeBaseDuration) {
        ...
        pushOperation(constants["v" /* TREE_OPERATION_UPDATE_TREE_BASE_DURATION */]);
        pushOperation(id);
  ...
  function recordResetChildren(fiber, childSet) {
    ...
    pushOperation(constants["t" /* TREE_OPERATION_REORDER_CHILDREN */]);
  ...
  if (Object(storage["d" /* sessionStorageGetItem */])(constants["o" /* SESSION_STORAGE_RELOAD_AND_PROFILE_KEY */]) === 'true') {
    startProfiling(Object(storage["d" /* sessionStorageGetItem */])(constants["n" /* SESSION_STORAGE_RECORD_CHANGE_DESCRIPTIONS_KEY */]) === 'true');
